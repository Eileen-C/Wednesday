<nav class="navbar navbar-expand-lg navbar-light fixed-top">
    <a class="navbar-brand" href="index_s01.php"><img src="./images/logo.jpg" alt="電商藥粧" class="img-fluid rounded-circle"></a>
                        ...
                        <li class="dropdown-item dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <?php while ($pyclass02_Rows = $pyclass02->fetch()) { ?>
                                    <li class="dropdown-item"><em class="fa <?php echo $pyclass02_Rows['fonticon']; ?> pr-2"></em><a href="drugstore.php?classid=<?php echo $pyclass02_Rows['classid']; ?>"><?php echo $pyclass02_Rows['cname']; ?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                    <?php } ?>
